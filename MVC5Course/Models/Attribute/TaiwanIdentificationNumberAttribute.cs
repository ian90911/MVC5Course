...
namespace MVC5Course.Models.Attribute
{
    ...
    public sealed class TaiwanIdentificationNumberAttribute:DataTypeAttribute
    {
        public TaiwanIdentificationNumberAttribute():base(DataType.Text)
        {
            ErrorMessage = "請輸入正確身分證字號格式";
        }
